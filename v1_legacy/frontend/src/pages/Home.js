      ...
      .then((res) => {
        ...
        if (res.data) {
          ...
          const objectURL = URL.createObjectURL(
            new File([res.data], this.state.filename, {
        ...
        <Container>
              ...
              <Form>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    min="0"
                    name="gamma"
                    ref={this.gammaValueRef}
                  />
                </Form.Group>
                <Button type="button" onClick={() => this.handlePost()}>
                  Invert Dark mode to Light!
                </Button>
              </Form>
            </Col>
          </Row>
          <Row>
            <Col md={6} id="img_before">
              <Image
                src={this.state.imgBefore || sample_before}
                alt="preview-img"
                fluid
              />
            </Col>
            <Col md={6} id="img_after">
              <a
                href={this.state.imgAfter || "#"}
                download={this.state.filename || null}
                className="w-100 h-100"
              >
                <Image
                  src={this.state.imgAfter || sample_after}
                  alt="preview-img"
                  fluid
                />
              </a>
